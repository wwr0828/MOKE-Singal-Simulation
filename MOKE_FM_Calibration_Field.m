...
Calib = [2.85*1.62, -28.72*1.24, -22.88*1.11, -18.70*1.05, -14.07*1.00, -10.88*0.99, -7.01*0.96, -6.11*0.94]/5; % -5.33*0.94 (64Py) -18.12*1.05 (16Py)calibration Kerr rotation (urad)
Calib2 = [-8.7*1.62, -5.72*1.24, -2.59*1.11, -1.77*1.05, -0.68*1.00, -0.24*0.99, 0.40*0.96, 1.09*0.94]; %calibration Kerr ellipticity (urad)
