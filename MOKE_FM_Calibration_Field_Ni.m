...
refrac_layer = 2.1+1i*4.3; % refractive index of the FM layer(for Ni, 2.4+1i*4.4)
...
Q_FM = 0.004-1i*0.006; % magneto-optic coefficient of (0.005-1i*0.008)
T_max = 60e-9; %The maximum thickness of the simulation (m)
m_z = 1.80e-3; %normalized magnetization tilt in z-direction, is actually m_z/M_s.(rad) (assume M_eff = 0.54T)
...
Calib = -2.36; % -5.33*0.94 (64Py) -18.12*1.05 (16Py)calibration Kerr rotation (urad)
Calib2 = 0.14; %calibration Kerr ellipticity (urad)
