...
T_max = 20e-9; %The maximum thickness of the simulation (m)
...
refrac = [1  refrac_Cu  refrac_layer  refrac_SiO2];  % Construct the total refractive index vector 
Q = [0  0  Q_FM  0];  % Construct the total magneto-optical constants vector  (air/Sio2/Al2O3/Py/Al2O3/SiO2/Si)
h = [inf  3e-9  T  inf];  % Construct the overall thickness vector (air/Sio2/Al2O3/Py/Al2O3/SiO2/Si)
mz = [0  0  m_z  0]; % Construct the overall magnetization vector in z-direction (air/Sio2/Al2O3/Py/Al2O3/SiO2/Si)
