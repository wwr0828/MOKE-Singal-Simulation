...
refrac_layer = 2.69+1i*3.68; % refractive index of the FM layer(for Ni, 2.4+1i*4.4)
...
Q_FM = 0.03-1i*0.01; % magneto-optic coefficient of (0.0036-1i*0.011)
T_max = 60e-9; %The maximum thickness of the simulation (m)
m_z = 0.19e-3; %normalized magnetization tilt in z-direction, is actually m_z/M_s.(rad) (assume M_eff = 2.24T)
...
Calib = -0.63; % -5.33*0.94 (64Py) -18.12*1.05 (16Py)calibration Kerr rotation (urad)
Calib2 = -0.81; %calibration Kerr ellipticity (urad)
...
%refrac_Al2O3 = 1.6716+1i*0; %refractive index of the oxidation (Al2O3) 1.6716+1i*0
Q_FM = 0.031-1i*0.004; % magneto-optic coefficient of (0.0036-1i*0.011)
